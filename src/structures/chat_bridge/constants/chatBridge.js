...
module.exports = {
	...
	blockedWordsRegExp: /\bsex\b|\bcum\b|nutte(?:d|r)|\bthot\b|pussy|\bpedo(?:phile|s)?\b|\byou'?r+?e? gay+\b|\bk+ys+\b|kil.+? yourself+\b|get aids|\bsuicide\b|braindead|\bchang\b|\bn+i[bg]{2,}(?:er+|a+)\b|\bk{3,}\b|\br+ape+\b|shoot yourself+\b|kkr|hope you die|\bmomo\b/i,
