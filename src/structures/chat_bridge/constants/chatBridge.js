...
module.exports = {
	...
	blockedWordsRegExp: /\bsex\b|\bcum\b|nutte(?:d|r)|\bthot\b|pussy|\ba+n+a+l+\b|suck my dick|nude|\bp+ornhub+(?:\..+)?\b|\bxhamster(?:\..+)?\b|\bpedo(?:phile|s)?\b|\b(?:you'?r+?e?|ur)(?: mom| dad)? gay+\b|fa(g+o+|g{2,})t|cocain|\bh+e+r+o+i+n+\b|\bk+ys+\b|kil.+? y *o *u *r *s *e *l *f+\b|school *shoot|get aids|autist|\bsuicide\b|\bslave\b|brain *dead|retarted|\bchang\b|\bn+i[bg]{2,}(?:er+|a+)\b|\bcoon+\b|\bk{3,}\b|\br+ape+\b|shoot yourself+\b|kkr|hope you die|\bmomo\b/i,
