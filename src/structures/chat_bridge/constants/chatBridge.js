...
module.exports = {
	...
	blockedWordsRegExp: /\bsex\b|\bcum\b|nutted|\bpedo(?:phile)?\b|\byou'?r+?e? gay+\b|\bk+ys+\b|kil.+? yourself+\b|\bn+igger+\b|\bk{3,}\b|\br+ape+\b|s+hoot yourself+\b|hope you die|\bmomo\b/i,
