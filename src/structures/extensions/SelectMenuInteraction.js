...
class LunarSelectMenuInteraction extends Structures.get('SelectMenuInteraction') {
	constructor(...args) {
		super(...args);
...
Structures.extend('SelectMenuInteraction', () => LunarSelectMenuInteraction);

module.exports = LunarSelectMenuInteraction;
